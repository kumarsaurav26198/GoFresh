...
const Images = {
  ...
  sideHome:require(BaseUrl+"home.png"),
  sideNotification:require(BaseUrl+"bell.png"),
  sideInvestor:require(BaseUrl+"investor.png"),
  sideStore:require(BaseUrl+"store.png"),
  sideInfo:require(BaseUrl+"info.png"),
  sideMyBook:require(BaseUrl+"myBook.png"),
  call: require(BaseUrl + 'call.png'),
  sideGlobe:require(BaseUrl+"globe.png"),
  sideSupport:require(BaseUrl+"24-hours-support.png"),
  setting: require(BaseUrl + 'setting.png'),
  sideLogout:require(BaseUrl+"logout.png"),
  password:require(BaseUrl+"password.png"),
};
